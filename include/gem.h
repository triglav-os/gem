 ...
 * graphics environment is unavailable.
 */
static inline WORD gem_compat_graf_handle4(WORD *wchar, WORD *hchar, WORD *wbox,
                                           WORD *hbox)
{
 ...
 */
static inline WORD gem_compat_wind_set(WORD handle, WORD field, intptr_t w1,
 ...
 */
static inline WORD gem_compat_wind_set5(WORD handle, WORD field, intptr_t w1,
                                        WORD w2, WORD w3)
{
 ...
 * Returns the result from `gem_compat_wind_set()`.
 */
static inline WORD gem_compat_wind_set6(WORD handle, WORD field, intptr_t w1,
                                        WORD w2, WORD w3, WORD w4)
{
