...
static void draw_frame(VDI_HANDLE handle, WORD width, WORD height)
{
    ...
    WORD center_lines[] = {(WORD)(width / 2),
                           12,
                           (WORD)(width / 2),
                           (WORD)(height - 13),
                           12,
...
static void draw_concentric_targets(VDI_HANDLE handle, WORD width, WORD height)
{
    ...
    vsl_color(handle, 0);
    for (radius = 28; radius <= min_word((WORD)(width / 3), (WORD)(height / 3));
         radius = (WORD)(radius + 28)) {
    ...
    v_ellarc(handle, cx, cy, (WORD)(width / 4), (WORD)(height / 5), 450, 1350);
}
...
static void draw_corner_pies(VDI_HANDLE handle, WORD width, WORD height)
{
    ...
    v_pieslice(handle, (WORD)(width - 49), (WORD)(height - 97), 24, 1800, 2700);
...
{
    WORD poly[] = {(WORD)(width / 2 - 120), (WORD)(height / 2 + 30),
    ...
    WORD contour_box[] = {(WORD)(width - 182), (WORD)(height - 112),
...
static void exercise_state_queries(VDI_HANDLE handle, WORD width, WORD height)
{
    ...
    (void)v_get_pixel(handle, (WORD)(width / 2), (WORD)(height / 2), &pel,
                      &index);
