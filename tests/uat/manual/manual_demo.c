...
enum { manual_demo_system_font = 1, manual_demo_small_font = 2 };
...
static void manual_demo_draw_header(VDI_HANDLE handle, WORD width,
...
static void manual_demo_mfdb_init(manual_demo_packed_mfdb_t *packed, WORD width,
                                  WORD height)
{
    size_t bytes;
...
static void manual_demo_step_listing_2_1(VDI_HANDLE handle, WORD width,
                                         WORD height)
{
    WORD pxy[12] = {12000, 12000, 12000, 20000, 14000, 21000,
                    16000, 20000, 16000, 12000, 12000, 12000};
    WORD index;
...
static void manual_demo_step_clipping(VDI_HANDLE handle, WORD width,
                                      WORD height)
{
    WORD clip[4] = {60, 70, (WORD)(width / 2), (WORD)(height - 40)};
    WORD bar_xy[4] = {20, 40, (WORD)(width - 20), (WORD)(height - 20)};
    WORD border[10] = {clip[0], clip[1], clip[2], clip[1], clip[2],
...
static void manual_demo_step_polyline_and_markers(VDI_HANDLE handle, WORD width,
                                                  WORD height)
{
    WORD line_xy[10] = {40,
                        (WORD)(height - 50),
                        ...
                        (WORD)(height - 50)};
    WORD marker_xy[8] = {
        80, 110, 160, 150, (WORD)(width - 160), 150, (WORD)(width - 80), 110};
...
static void manual_demo_step_text_and_fonts(VDI_HANDLE handle, WORD width,
                                            WORD height)
{
    BYTE name[64] = {0};
    WORD font_id;
...
static void manual_demo_step_fillarea_and_bar(VDI_HANDLE handle, WORD width,
                                              WORD height)
{
    WORD polygon[10] = {90,
                        90,
...
static void manual_demo_step_cellarray(VDI_HANDLE handle, WORD width,
                                       WORD height)
{
...
static void manual_demo_step_contourfill(VDI_HANDLE handle, WORD width,
                                         WORD height)
{
    WORD frame[10] = {130,
                      90,
...
static void manual_demo_step_arc_family(VDI_HANDLE handle, WORD width,
                                        WORD height)
{
...
static void manual_demo_step_rounded_boxes(VDI_HANDLE handle, WORD width,
                                           WORD height)
{
    WORD left[4] = {80, 90, (WORD)(width / 2 - 20), (WORD)(height - 80)};
    WORD right[4] = {(WORD)(width / 2 + 20), 90, (WORD)(width - 80),
                     (WORD)(height - 80)};
...
static void manual_demo_step_justified(VDI_HANDLE handle, WORD width,
                                       WORD height)
{
    (void)width;
    (void)height;
    ...
    (void)vst_font(handle, manual_demo_system_font);
    v_justified(handle, 40, 180, "SECOND PASS WITH THE SYSTEM FONT", 32, 0, 0);
}

static void manual_demo_step_write_modes(VDI_HANDLE handle, WORD width,
                                         WORD height)
{
...
static void manual_demo_step_queries(VDI_HANDLE handle, WORD width, WORD height)
{
    WORD attrib[57] = {0};
    WORD extent[8] = {0};
    WORD width_q = 0;
...
static void manual_demo_step_cursor_helpers(VDI_HANDLE handle, WORD width,
                                            WORD height)
{
    WORD row = 0;
    WORD column = 0;
