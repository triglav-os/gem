/*
 * Implements file and path descriptor management for desktop windows and
 * launcher logic. The code tracks the filesystem state that backs open
...
EXTERN WORD strchk(BYTE *left, BYTE *right);
