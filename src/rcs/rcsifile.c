/*
 * Implements icon-file loading and saving helpers used by the resource
 * construction set. The routines manage the serialized form of icon
 * resources.
 *
