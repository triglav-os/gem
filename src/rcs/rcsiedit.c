/*
 * Implements icon and image editing helpers used by the resource
 * construction set. The file handles specialized editing behavior for
 * bitmap-oriented resource content.
 *
...
else LWCOPY(des_pt, ADDR(dtemp), gl_datasize);
}