/*
 * Provides compiler and declaration compatibility macros used throughout
 * the imported resource construction set. It helps keep historical calling
 * conventions contained.
 *
