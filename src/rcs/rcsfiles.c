/*
 * Implements the resource construction set file workflow, including open,
 * save, and related prompts. These routines are a key boundary between the
 * editor state and on-disk resources.
 *
...
else strcpy(sav_rcspath, tmp_path);
	tmp_name[0] = '\0';
