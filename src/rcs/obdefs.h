/*
 * Defines GEM object-tree structures, flags, and helper macros used by the
 * resource construction set. The editor depends heavily on stable object
 * layouts and resource indices.
 *
