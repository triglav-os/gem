/*
 * Implements GEM binding wrappers used by the resource construction set.
 * These helpers let the editor talk to AES and VDI services through a
 * narrower interface.
 *
...
WORD wind_get(WORD w_handle, WORD w_field, WORD *pw1, WORD *pw2, WORD *pw3, WORD *pw4)
{
	...
	*pw4 = WM_OH;
	...
	WORD wind_set(w_handle, w_field, w1, w2, w3, w4)
	WORD		w_handle;	
	WORD		w_field;
	WORD		w1, w2, w3, w4;
{
