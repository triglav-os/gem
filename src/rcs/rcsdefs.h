/*
 * Defines editor-wide constants, object identifiers, and structural limits
 * for the resource construction set. The values capture assumptions baked
 * into the original editor workflow.
 *
...
EXTERN	LONG	save_tree, gl_icnspec;
...
EXTERN	LONG	src_mp, dst_mp;
EXTERN	LONG	ibuff_size;
EXTERN  WORD    fgcolor, bgcolor;
#define  MAX_DATA   256

/*use word length not long length*/
#define dos_read(x,y,z) read_piece(x,y,z)
#define dos_write(x,y,z) write_piece(x,y,z)
...
EXTERN	WORD	rcs_rhndl;
EXTERN	WORD	rcs_dhndl;
...
EXTERN	WORD	rcs_hhndl;	/* used in write_files and c_ routines */
