/*
 * Declares shared editor state, globals, and key interfaces for the
 * resource construction set. It is one of the main internal headers tying
 * the editor modules together.
 *
