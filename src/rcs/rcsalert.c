/*
 * Implements alert creation and alert-editing support used by the resource
 * construction set. The routines manage one of the specialized object
 * types handled by the editor.
 *
...
#include "rcsext.h"
	...
	VOID pt_parse(tree, obj0, nobj, where, here)
	LONG	tree, where;
	WORD	obj0, nobj, *here;
	{
	WORD	iobj;
	...
	VOID pt_unparse(tree, obj0, nobj, where, here)
	LONG	tree, where;
	WORD	obj0, nobj, *here;
	{
	LONG	obspec;
	...
	*here += 1;
	...
	VOID pt_count(tree, obj0, nobj, n, mxl)
	LONG	tree;
	...
	*n = *mxl = 0;
	...
	VOID al_count(tree, pic, nmsg, mxlmsg, nbut, mxlbut)
	LONG	tree;
