/*
 * Declares helpers and constants used when editing object and widget
 * tables in the resource construction set. The header supports one of the
 * editor more specialized workflows.
 *
