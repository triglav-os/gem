/*
 * Defines DOS-facing constants and data structures used by the imported
 * desktop shell. The header records host assumptions that will need to be
 * abstracted for Linux.
 *
