/*
 * Defines resource tree, object, icon, and string identifiers generated
 * from the desktop resource set. The values must remain aligned with the
 * compiled desktop resources.
 *
