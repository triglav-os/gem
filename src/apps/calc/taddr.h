/*
 * Declares the resource address tables generated for the Calclock
 * accessory. The symbols let the sample code reach strings, TEDINFO
 * blocks, and object trees by index.
 *
