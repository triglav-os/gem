/*
 * Declares resource identifiers, constants, and entry points for the
 * calculator accessory. The definitions tie the calculator logic to its
 * compiled GEM resource tree.
 *
