/*
 * Declares the GEM AES binding functions used by the Calclock accessory.
 * The interface mirrors the original application-side calling convention.
 *
...
#define AP_GLENGTH global[1]
#define AP_COUNT global[2]
#define AP_ID global[3]
#define AP_LOPRIVATE global[4]
#define AP_HIPRIVATE global[5]
#define AP_LOPNAME global[6]
#define AP_HIPNAME global[7]
#define AP_LO1RESV global[8]
#define AP_HI1RESV global[9]
#define AP_LO2RESV global[10]
#define AP_HI2RESV global[11]
#define AP_LO3RESV global[12]
#define AP_HI3RESV global[13]
#define AP_LO4RESV global[14]
#define AP_HI4RESV global[15]
...
#define SC_BINARY 0x0001
#define SC_ASCII 0x0002
#define SC_DIF 0x0004
#define SC_METAFILE 0x0008
#define SC_USERDEF 0x00010
#define SC_NEWSCRAP 0x8000

#define SC_INTYPE int_in[0]
#define SC_OUTTYPE int_out[1]
#define SC_AVAIL int_out[2]
#define SC_USED int_out[3]

#define SC_RWTYPE int_in[0]
#define SC_RWSIZE int_in[1]

#define SC_RWBUFF addr_in[0]
