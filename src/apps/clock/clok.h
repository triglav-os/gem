/*
 * Declares resource identifiers and helper interfaces for the clock
 * portion of the Calclock accessory. The definitions are shared by the
 * accessory startup and UI modules.
 *
...
{
	0x0L, -1L, -1L, IBM, S_XOR_D, TE_CNTR, 0x1103, WHITE, 0, 13, 13,
	0x1L, -1L, -1L, IBM, S_XOR_D, TE_CNTR, 0x1103, WHITE, 0, 13, 13,
	0x2L, -1L, -1L, IBM, S_XOR_D, TE_CNTR, 0x1103, WHITE, 0, 13, 13,
	0x3L, -1L, -1L, IBM, S_XOR_D, TE_CNTR, 0x1405, WHITE, 0, 13, 13,
	0x4L, -1L, -1L, IBM, S_XOR_D, TE_CNTR, 0x1405, WHITE, 0, 13, 13,
	0x5L, -1L, -1L, IBM, S_XOR_D, TE_CNTR, 0x1405, WHITE, 0, 13, 13,
	0x6L, -1L, -1L, IBM, S_XOR_D, TE_CNTR, 0x1405, WHITE, 0, 13, 13
};
